...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show   pace-done pace-done">
                ...
                <ul class="nav">
                    ...
                    @if(auth::check())
                        @if(auth()->user()->role=='ADMIN')
                            <li class="nav-item">
                                <a class="nav-link active" href="{{route('index.plantilla')}}">
                                    <i class="nav-icon icon-book-open"></i> Plantillas
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="{{route('index.usuarios')}}">
                    ...
                    @if(auth::check())
                        @if(auth()->user()->role=='USUARIO')
                            <li class="nav-item">
                                <a class="nav-link active" href="{{route('index.pagina')}}">
                            ...
                            <li class="nav-title">Configuraciones</li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('index.menu')}}">
                                        <i class="nav-icon icon-grid"></i> Menu</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('index.enlace')}}">
                                        <i class="nav-icon icon-list"></i> Enlace</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('index.slider')}}">
                                        <i class="nav-icon icon-film"></i> Slider</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('index.contacto')}}">
                                        <i class="nav-icon icon-envelope"></i> Mensajes</a>
                                </li>
                            @endif
                        @endif
                    @endif               
    ...
    <footer class="app-footer">
        <div>
            <span>Derechos Reservados a Argenis Inc</span>
        </div>
        <div class="ml-auto">
            <span>@ 2020</span>
        </div>
