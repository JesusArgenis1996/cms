...
<html class="wide wow-animation" lang="en">
  ...
  <body style="font-family: {{$general->fuente}} !important; font-size: {{$general->size}} !important; background-image:url({{asset('recursos_fondo/'.{{$general->fondo}}">
    <div class="preloader">
              ...
              <div class="rd-navbar-aside">
                <div class="rd-navbar-collapse">
                  <ul class="contacts-classic">
                    <li><span class="contacts-classic-title" style="color: {{$menu->color}} !important">Call us:</span> <a href="tel:#">{{$footer->telefono}}</a>
                    </li>
                    <li><a href="mailto:#">{{$footer->correo}}</a></li>
                  </ul>
                </div>
                <!-- RD Navbar Panel-->
                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    @foreach($items_menu as $item)
                        <li class="rd-nav-item active" style="color: {{$menu->color}} !important">
                         <a class="rd-nav-link" href="{{$item->enlace}}"><?php echo $item->icono?>{{ $item->titulo}}</a>
                        </li>
                    @endforeach
                  </ul>
                </div>
            ...
            <div class="row row-40 row-md-50 justify-content-xl-between">
                ...
                <div class="inset-xl-right-70">
                  ...
                  @foreach($galeria_footer as $item)
                    <div class="col-4 col-sm-2 col-lg-4">
                      <a class="thumbnail-minimal" href="{{asset('galeria/'.$item->imagen)}}" data-lightgallery="item">
                      <img src="{{asset('galeria/'.$item->imagen)}}" alt="" width="93" height="93"/>
                    </a>
                    </div>
                  @endforeach
                  </div>
              ...
              <div class="col-sm-6 col-md-7 col-lg-5 wow fadeInRight" data-wow-delay=".1s">
                ...
                <ul class="footer-modern-list footer-modern-list-2 d-sm-inline-block d-md-block">
                  @foreach($items_menu as $item)
                        <li style="color: {{$menu->color}} !important">
                        <a class="rd-nav-link" href="{{$item->enlace}}">
                             <?php echo $item->icono?>{{ $item->titulo}}
                        </a>
                        </li>
                    @endforeach
                </ul>
