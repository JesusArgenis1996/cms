          ...
          <div class="row row-30">
            ...
            <div class="col-sm-6 col-lg-4">
              <!-- Post Classic-->
                ...
                <article class="post post-classic box-md"><a class="post-classic-figure" href="http://127.0.0.1:8000/inmaculada/contenido/pagina/blog/{{$item->slug}}">
                    <img src="{{asset('blog/'.$item->imagen)}}" alt="" width="370" height="239"/></a>
