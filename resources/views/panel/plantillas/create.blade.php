...
<ol class="breadcrumb">
    ...
    <div class="container-fluid">
        <div id="ui-view">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <form method="POST" role="form" enctype="multipart/form-data" action="{{route('store.plantilla')}}">
                        {{csrf_field()}}
                        <div class="card">
                            <div class="card-header">
                                <h4>CREACION DE PLANTILLAS</h4>
                            </div>
                            <div class="card-body">
                                <div class="col-lg-12 form-group">
                                    <input type="text" class="form-control {{$errors->has('titulo') ? 'is-invalid' : ''}}"
                                        placeholder="Titulo de la plantilla" name="titulo">
                                ...
                                <div class="col-lg-12 form-group">
                                    <textarea class="form-control {{$errors->has('descripcion') ? 'is-invalid' : ''}}"
                                        name="descripcion" placeholder="Descripcion de la plantilla"></textarea>
